...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        skillCatAnimationFocus: { en: "Animation Focus", vi: "Trọng Tâm Diễn Hoạt", ja: "アニメーション中心" },
        ...
        skillIllustCore: { en: "Character Design & Anime-Inspired Illustration", vi: "Thiết Kế Nhân Vật & Minh Họa Phong Cách Anime", ja: "キャラクターデザイン・アニメ風イラスト" },
        ...
        skillSoftwareNote: { en: "Proficient with key industry software for 2D animation and illustration.", vi: "Thành thạo các phần mềm chủ chốt trong ngành diễn hoạt 2D và minh họa.", ja: "2Dアニメ・イラスト制作の主要ソフトに習熟" },
        ...
        softSkillLearnPassion: { en: "Passion for Anime & Commitment to Continuous Learning", vi: "Đam Mê Anime & Cam Kết Học Hỏi Không Ngừng", ja: "アニメへの情熱と継続的な学習意欲" },
        ...
        worksAnimTitle: { en: "ANIMATION REEL & CLIPS", vi: "DEMO REEL & CLIP HOẠT HÌNH", ja: "アニメーションリール＆クリップ" }, worksReelNote: { en: "(Replace with your animation reel from Vimeo/YouTube)", vi: "(Thay thế bằng video tổng hợp hoạt hình của bạn từ Vimeo/YouTube)", ja: "（Vimeo/YouTubeのアニメーションリールに置き換えてください）" },
        worksIllustTitle: { en: "ILLUSTRATION GALLERY", vi: "THƯ VIỆN MINH HOẠ", ja: "イラストギャラリー" },
        illust1Title: { en: "CHARACTER CONCEPT: AKIRA", vi: "Ý TƯỞNG NHÂN VẬT: AKIRA", ja: "キャラクターコンセプト：アキラ" }, illust1Desc: { en: "Original character design exploring a cyberpunk theme. Focus on dynamic pose and lighting.", vi: "Thiết kế nhân vật gốc khám phá chủ đề cyberpunk. Tập trung vào tư thế động và ánh sáng.", ja: "サイバーパンクをテーマにしたオリジナルキャラクターデザイン。ダイナミックなポーズとライティングに焦点。" },
        illust2Title: { en: "SCENE: NEON ALLEYS", vi: "CẢNH: HẺM NEON", ja: "シーン：ネオン路地" }, illust2Desc: { en: "Background art practice, focusing on atmosphere and color in a dense urban environment.", vi: "Thực hành vẽ cảnh nền, tập trung vào không khí và màu sắc trong môi trường đô thị dày đặc.", ja: "密集した都市環境における雰囲気と色彩に焦点を当てた背景美術の練習。" },
        viewDetail: { en: "VIEW DETAIL >>", vi: "XEM CHI TIẾT >>", ja: "詳細を見る >>"}, viewProjectHover: { en: "View Project", vi: "Xem Dự Án", ja: "プロジェクトを見る"},
        updatesTitle: { en: "LATEST UPDATES", vi: "CẬP NHẬT MỚI NHẤT", ja: "最新情報" }, ARTICLE_TITLE_1: { en: "NEW PROJECT ANNOUNCEMENT: DELTA", vi: "THÔNG BÁO DỰ ÁN MỚI: DELTA", ja: "新プロジェクト発表：デルタ" }, ARTICLE_TITLE_2: { en: "YR FOLIO DESIGN BREAKDOWN", vi: "PHÂN TÍCH THIẾT KẾ YR FOLIO", ja: "YR FOLIO デザイン詳細" }, ARTICLE_TITLE_3: { en: "UPCOMING WORKSHOP ON CREATIVE CODING", vi: "WORKSHOP SẮP TỚI VỀ LẬP TRÌNH SÁNG TẠO", ja: "クリエイティブコーディングに関する今後のワークショップ" },
        ...
        footerRights: { en: `© ${currentYearValForTranslations} PHAT TRAN // ANIMATOR & ILLUSTRATOR. ALL RIGHTS RESERVED.`, vi: `© ${currentYearValForTranslations} PHAT TRAN // ANIMATOR & HOẠ SĨ MINH HOẠ. BẢN QUYỀN THUỘC VỀ.`, ja: `© ${currentYearValForTranslations} PHAT TRAN // アニメーター＆イラストレーター。全著作権所有。` },
    ...
    // Lưu trữ các instance của TextScrambleEffect cho menu để cập nhật khi đổi ngôn ngữ
